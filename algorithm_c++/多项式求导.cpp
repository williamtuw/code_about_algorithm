...
//	//int n,k;
//	//string temp,mod;
//	//BigNumber divNum("998244353", 0,1);
//	//BigNumber tempNum;
//	//cin >> n >>k;
//	//for (int i = 0; i < n + 1; i++)
//	//{
...
//	//	for (int j = n; j > i; j--)
//	//	{
//	//		tempNum = Array[j - 1].mul(BigNumber(n - j + 1));
//	//		tempNum.div(tempNum.getValue(), divNum.getValue(), mod);
//	//		Array[j] = BigNumber(mod, 0, 1);
//	//	}
//	//		
//	//	Array[i] = BigNumber("0",0,1);
//	//}
//	//for (int i = 0; i < n + 1; i++)
//	//{
//	//	if(i!=n)cout << Array[i].getValue() << " ";
//	//	else cout << Array[i].getValue() << endl;
//	//}
//	BigNumber A, B;
//
//	string a, b;
...
//	B.parse(b);
//
//	cout << A.getRealValue() <<" "<< A..getRealValue() << endl;
//
//
//
//	return 0;
